    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            Expanded(
              // SalienaAdaptiveContent constrains to 480 pt on iPad;
              // has zero effect on phones narrower than 480 pt.
  ...
  Widget _buildReportCard(BuildContext context, Report report) {
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () =>
              context.push('${Routes.reportDetail}/${report.id}', extra: report),
          borderRadius: BorderRadius.circular(4),
          child: Padding(
            padding: const EdgeInsets.all(16.0),
            child: Column(
